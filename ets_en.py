...
info.to_csv('/content/drive/MyDrive/nnar_en_edited.csv')
...
dataframe[['Total Views','HWES1']].plot(title='Holt Winters Single Exponential Smoothing For English')
plot.xlabel('Days')
...
dataframe[['Total Views','HWES2_ADD','HWES2_MUL']].plot(title='Holt Winters Double Exponential Smoothing: Additive and Multiplicative Trend For English');
plot.xlabel('Days')
plot.ylabel('Total Views')
...
dataframe[['Total Views','HWES3_ADD','HWES3_MUL']].plot(title='Holt Winters Triple Exponential Smoothing: Additive and Multiplicative Seasonality for English')
plot.xlabel('Days')
plot.ylabel('Total Views')
...
plt.title('Train, Test and Predicted Test using Holt Winters for English')
plot.xlabel('Days')
plot.ylabel('Total Views')
