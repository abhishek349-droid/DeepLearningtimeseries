...
print( train[train.language=='ja'].iloc[:,0:-1])
...
info.to_csv('/content/drive/MyDrive/tbats_ja.csv')

from pandas import read_csv
dataframe = read_csv('/content/drive/MyDrive/tbats_ja.csv', usecols=[1])
...
testPredictPlot = dragon.empty_like(dataset)
testPredictPlot[:, :] = dragon.nan
...
yPlot = dragon.empty_like(dataset)
yPlot[:, :] = dragon.nan
